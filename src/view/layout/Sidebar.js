            ...
            <ul className="space-y-2 font-medium  ">
              ...
              <li>
                ...
                >
                  ...
                  <span className="ml-3 text-sidebar_text_color hover:text-sidebar_hover_color">
                    Dashboard
                  </span>
                </a>
              </li>
              {/* <li>
                <a
                  ...
                  className={`flex items-center p-2 rounded-lg ${
                    nav === "/dashboard"
                      ? "bg-sidebar_hover_color hover:text-sidebar_hover_color"
                      : "hover:bg-sidebar_hover_color"
              ...
              <li>
                ...
                >
                  <svg
                    className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text- dark:group-hover:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 22 21"
