...
import { DELETE_PRODUCT_CAT, PRODUCT_CAT_PK } from "../../gql/productCategory";

const DeleteProductBrand = () => {
  ...
  console.log("produclt", product);
  const [delete_serviceDetail] = useMutation(DELETE_PRODUCT_CAT, {
    onError: (err) => {
  ...
  const handleDelete = async () => {
    try {
      await delete_serviceDetail({
        variables: { id: product?.product_category_by_pk.id },
      });
    } catch (err) {
